...
> 2026-05-08~05-21 #CL-19~39 상세: [archive/CRITICAL_LOGIC_archive_20260508_20260521.md](archive/CRITICAL_LOGIC_archive_20260508_20260521.md)

---

## [결정 #CL-19] (SUPERSEDED by #CL-20, 2026-05-10) MVP 출시 전 이메일 로그인 코드 전면 제거 (2026-05-08)

**상세 이관**: [2026-05-08~2026-05-21 종결 결정 아카이브](archive/CRITICAL_LOGIC_archive_20260508_20260521.md)
...
## [결정 #CL-166] 디어오키드 MVP는 기존 판매 로직과 분리된 주간 회차 직배송 경로를 사용한다 (2026-07-15)

- **결정**: 디어오키드는 `Store.salesMode: round_direct`에서 `saleRounds`, `saleRoundItems`, 15분 `checkoutReservations`, 다중 상품 주문 스냅샷을 사용한다. 값이 없거나 `legacy`인 스토어의 택배·거점픽업·공동구매 주문은 기존 로직을 유지한다.
- **운영 계약**: 일요일 24:00 주문 마감, 월요일 경매 매입, 화요일 00:00~09:00 이천시 직접배송을 한 회차로 관리한다. 배송지 15곳 또는 호접란 30개 중 먼저 도달한 한도를 적용하며 보류 주문이 있으면 회차 완료를 막는다.
