...
| 🟢 P3 | **셀러 UX 잔여(UX-07~09) 정합** — ✅ T-UX1 탭 단일화(세션54)·T-UX2 상품 카드 Badge 분리·T-UX3 ConfirmModal 6곳 교체·T-UX4a/b/c fontSize 토큰화·T-UX5 정합성 검토. UX-10은 자연 해소(⏹️). Railway 무관 | UX/DX | `specs/frontend/seller-ux-residual-plan.md` (세션53 수립) |
