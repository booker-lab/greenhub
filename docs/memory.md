...
최종 수정: 2026-07-17 (Task 3.5 운영 예외 테스트 계약 고정 완료)

## 현재 진행

- 브랜치 `codex/mvp-sales-round-direct`, Task 3.5 로컬 변경 검증 완료.
...
- Task 3.6에서 `OperationsService`의 멱등 운영 예외 통합과 최신 상태 기반 조치·감사 기록을 구현한다.
