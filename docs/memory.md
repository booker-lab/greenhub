...
최종 수정: 2026-07-17 (Task 3.10 법정 기록 보관·파기 서비스 구현 완료)

## 현재 진행

- 브랜치 `codex/mvp-sales-round-direct`, Task 3.10 로컬 변경 검증 완료.
...
- Task 3.11에서 `retention.module.ts`를 추가해 보관 서비스를 내보내고 빌드 계약을 검증한다.
