...
최종 수정: 2026-07-17 (전수 리뷰 보정 Unit 2 완료)
...
- 완료: Unit 1 결제·예약 최종 정합성, Unit 2 주문 조회·웹훅 보안 경계
- 다음: Unit 3 주문 상태·취소·보류 원자성
...
- Unit 2 주문 권한 테스트 6개, PortOne 테스트 7개, 조합 13개 통과.
- Unit 1 회귀 테스트 24개 통과.
