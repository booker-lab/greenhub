...
최종 수정: 2026-07-17 (Task 3.7 운영 예외 조회·조치 API 구현 완료)

## 현재 진행

- 브랜치 `codex/mvp-sales-round-direct`, Task 3.7 로컬 변경 검증 완료.
...
- Task 3.8에서 `operations.module.ts`를 구현하고 운영 예외 서비스를 기존 결제·알림·주문 경로에서 재사용할 수 있게 연결한다.
