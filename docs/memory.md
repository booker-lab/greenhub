...
최종 수정: 2026-07-17 (Task 3.9 보관 기간 파기 계약 고정 완료)

## 현재 진행

- 브랜치 `codex/mvp-sales-round-direct`, Task 3.9 로컬 변경 검증 완료.
...
- Task 3.10에서 `retention.service.spec.ts`의 목적별 저장·만료·보존 연장·멱등 파기 계약을 만족하는 `retention.service.ts`를 구현한다.
