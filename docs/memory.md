...
최종 수정: 2026-07-17 (Task 3.2 알림톡 재시도와 문자 대체 구현 완료)

## 현재 진행

- 브랜치 `codex/mvp-sales-round-direct`, Task 3.2 로컬 변경 검증 완료.
...
- Task 3.3에서 문자 대체까지 실패할 때 멱등 `CUSTOMER_NOTICE_FAILED` 운영 예외를 기록해야 한다. 주문 상태는 변경하지 않는다.
