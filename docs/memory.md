...
최종 수정: 2026-07-17 (Task 3.8 운영 예외 모듈 연결 완료)

## 현재 진행

- 브랜치 `codex/mvp-sales-round-direct`, Task 3.8 로컬 변경 검증 완료.
...
- Task 3.9에서 90일·3년·5년 만료와 분쟁 연장 파기 계약을 `retention.service.spec.ts`에 실패 테스트로 고정한다.
