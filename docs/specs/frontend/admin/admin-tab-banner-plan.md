...
> **구현 진행:** 2026-05-30 T1·T2·T3·T5a 완료. T6 CTA 반응형 일부(SimpleGrid 1열/2열) 동시 반영.
...
- [x] **T5a (F2). 이미지 업로드 가드** — PNG/JPG/WebP 형식과 2MB 용량 상한을 업로드 전 검증하고 실패 사유를 인라인·알림으로 표시.
- **T5b (F2). 이미지 orphan cleanup** — 교체·삭제 시 옛 파일 정리는 다중 배너 SDD U2에 흡수(Q10).
