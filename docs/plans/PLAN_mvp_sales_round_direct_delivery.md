...
## Closeout Roll-up
- **Status**: Task 5.4 `done`, Task 5.5 `todo`
...
- **다음 진입점**: Task 5.5 `apps/seller/src/app/sale-rounds/[id]/page.tsx`만 시작할 수 있다.
