...
- **현재 진입점**: Task 5.8 셀러 주문 업무 우선순위 표시를 완료했으며 다음 작업은 Task 5.9다.
...
## Closeout Roll-up
- **Status**: Task 5.8 `done`, Task 5.9 `todo`
...
- **다음 진입점**: Task 5.9 `apps/seller/src/app/orders/[id]/page.tsx`만 시작할 수 있다.
