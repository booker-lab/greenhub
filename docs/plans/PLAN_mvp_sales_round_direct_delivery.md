...
## Closeout Roll-up
- **Status**: Task 5.7 `done`, Task 5.8 `todo`
...
- **다음 진입점**: Task 5.8 `apps/seller/src/app/orders/page.tsx`만 시작할 수 있다.
