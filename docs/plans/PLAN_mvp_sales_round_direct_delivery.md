...
## Closeout Roll-up
- **Status**: Task 5.2 `done`, Task 5.3 `todo`
...
- **다음 진입점**: Task 5.3 `apps/seller/src/app/sale-rounds/page.tsx`만 시작할 수 있다. Task 5.4 이후 셀러 편집 화면, 드라이버 화면, 인덱스·보안 규칙은 앞서 구현하지 않는다.
