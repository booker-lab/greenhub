...
## Closeout Roll-up
- **Status**: Task 5.3 `done`, Task 5.4 `todo`
...
- **다음 진입점**: Task 5.4 `apps/seller/src/app/sale-rounds/[id]/RoundForm.tsx`만 시작할 수 있다. Task 5.5 이후 셀러 편집 라우트, 드라이버 화면, 인덱스·보안 규칙은 앞서 구현하지 않는다.
