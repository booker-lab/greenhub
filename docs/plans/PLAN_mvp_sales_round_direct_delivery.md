...
## Closeout Roll-up
- **Status**: Task 5.6 `done`, Task 5.7 `todo`
...
- **다음 진입점**: Task 5.7 `apps/seller/src/app/settings/page.tsx`만 시작할 수 있다.
