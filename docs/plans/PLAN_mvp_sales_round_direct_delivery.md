...
## Closeout Roll-up
- **Status**: Task 5.5 `done`, Task 5.6 `todo`
...
- **다음 진입점**: Task 5.6 `apps/seller/src/components/BottomNav.tsx`만 시작할 수 있다.
