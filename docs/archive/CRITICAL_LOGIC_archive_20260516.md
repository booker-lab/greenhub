# Critical Logic — 아카이브 (2026-03 ~ 2026-04)

> 이 파일은 `docs/CRITICAL_LOGIC.md`에서 분리한 종결 설계 결정 이력입니다.
> 2026-05-16(세션30)에 #CL 이전(2026-03~04) 엔트리를 일괄 이관했습니다.
> 활성 결정(#CL-19 이후)은 [../CRITICAL_LOGIC.md](../CRITICAL_LOGIC.md) 참조.
